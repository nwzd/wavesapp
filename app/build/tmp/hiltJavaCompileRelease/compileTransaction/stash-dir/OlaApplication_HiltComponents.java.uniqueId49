...
import com.olapp.ble.BleForegroundService_GeneratedInjector;
import com.olapp.ble.BootReceiver_GeneratedInjector;
import com.olapp.di.AppModule;
...
public final class OlaApplication_HiltComponents {
  private OlaApplication_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements OlaApplication_GeneratedInjector,
  ...
  @Subcomponent
  @ServiceScoped
  public abstract static class ServiceC implements BleForegroundService_GeneratedInjector,
      ServiceComponent,
      GeneratedComponent {
  ...
  @Subcomponent(
      modules = {
          ...
          OlaViewModel_HiltModules.KeyModule.class,
  ...
  @Subcomponent(
      modules = {
          ...
          OlaViewModel_HiltModules.BindsModule.class,
