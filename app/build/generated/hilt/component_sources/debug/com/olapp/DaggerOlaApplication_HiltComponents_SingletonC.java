...
import com.olapp.di.AppModule_ProvideBlockedUserDaoFactory;
...
public final class DaggerOlaApplication_HiltComponents_SingletonC {
  ...
  private static final class ServiceCImpl extends OlaApplication_HiltComponents.ServiceC {
    ...
    private BleForegroundService injectBleForegroundService2(BleForegroundService instance) {
      ...
      BleForegroundService_MembersInjector.injectAppPreferences(instance, singletonCImpl.appPreferencesProvider.get());
      return instance;
    }
  }
  ...
  private static final class SingletonCImpl extends OlaApplication_HiltComponents.SingletonC {
    ...
    private BlockedUserDao blockedUserDao() {
      return AppModule_ProvideBlockedUserDaoFactory.provideBlockedUserDao(provideDatabaseProvider.get());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new UserRepository(singletonCImpl.userProfileDao(), singletonCImpl.receivedOlaDao(), singletonCImpl.sentOlaDao(), singletonCImpl.matchDao(), singletonCImpl.blockedUserDao());
